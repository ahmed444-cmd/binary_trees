 ...
 * @offset: Position offset for printing
 * @depth: Depth level of the node
 * @s: Buffer for storing the printed tree
 *
 * Return: The length of the tree after processing
 */
 ...
 *
 * @tree: Pointer to the node from which the height is measured
 *
 * Return: The height of the tree starting from @tree
 */
...
/**
 * binary_tree_print - Outputs the structure of a binary tree
 *
